...
Nextfolio uses [custom MDX](https://github.com/jmgogo/jmgogo.github.io/blob/main/app/components/mdx.tsx) for blog posts, making it easy to include JSX components such as interactive embeds, charts, or alerts directly in your markdown content.
...
- Nextfolio uses [deno](https://docs.deno.com/runtime/) for package management.
...
Nextfolio uses a custom [image grid component](https://github.com/jmgogo/jmgogo.github.io/blob/main/app/components/image-grid.tsx) to display image galleries.
...
Nextfolio uses a custom [table component](https://github.com/jmgogo/jmgogo.github.io/blob/main/app/components/mdx.tsx#L38) to render tables in MDX posts.
...
Nextfolio uses a custom [callout component](https://github.com/jmgogo/jmgogo.github.io/blob/main/app/components/mdx.tsx#L63) to render important information in MDX posts.

```
<Callout emoji="💡">
[Nextfolio](https://nextfolio.site) is a clean, simple, and fast portfolio built with Next.js, Tailwind CSS, and Deno for optimal performance.
</Callout>
```
...
<Callout emoji="💡">
  ...
  built with Next.js, Tailwind CSS, and Deno for optimal performance.
</Callout>
