...
- Analytics: [Vercel Web Analytics](https://vercel.com/docs/analytics) and [Speed Insights](https://vercel.com/docs/speed-insights)
...
Nextfolio uses [deno](https://docs.deno.com/runtime/) for dependency management, so ensure it is installed on your system.

Execute [`create-next-app`](https://github.com/vercel/next.js/tree/canary/packages/create-next-app) with [deno](https://docs.deno.com/runtime/) to bootstrap the example:
